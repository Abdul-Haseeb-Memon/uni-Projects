...
class login_page:
    def __init__(self, root):
        ...
        label1 = Label(self.frame1, text= "M", font=("times new roman", 40, "bold"), bg="yellow", fg="red").place(x=100,y=300)
        label2 = Label(self.frame1, text= "uet", font=("times new roman", 40, "bold"), bg="yellow", fg="RoyalBlue1").place(x=150,y=300)
        label3 = Label(self.frame1, text= "It's all about Success", font=("times new roman", 13, "bold"), bg="yellow", fg="brown4").place(x=100,y=360)
